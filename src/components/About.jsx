  ...
  return (
    <>
      ...
      <div className='about-wrapper'>
        {/*  <img className='bg-logo' src={webLogo} alt='black garlic logo' /> */}
        <h2>
          welcome to <span className='bold'>black garlic furniture</span>
        </h2>
        <p className='about-text'>
          we're pretty passionate about making furniture that not only brightens
          up your home but is good for the planet and it's people. inspired by
          aotearoa's natural beauty, our designs reflect a commitment to clean
          design, eco-conscious materials, and the diy spirit.
        </p>
        {/*  <p className='about-text bold'>
          join us in creating a home that harmonizes with both your lifestyle
          and the environment.
        </p> */}
        ...
        <div className='mtt-wrapper'>
          <div className='person-wrapper'>
            ...
            <p className='person-bio'>
              Meet Jenna, the creative force behind our designs. with an eye for
              clean design and a passion for sustainability, Jenna crafts
          ...
          <div className='person-wrapper'>
            ...
            <p className='person-bio'>
              ...
              furniture to life. with a knack for storytelling and a commitment
              to ethical branding, Graeme ensures that our message of
              sustainability and style resonates with our audience. he believes
              that every piece has a tale, and he's here to share it with the
              world.
            </p>
          </div>
          <div className='person-wrapper'>
            ...
            <p className='person-bio'>
              Miles is the hands behind the craft. as our manufacturer, he turns
              raw materials into works of art. with precision and dedication,
              Miles brings the designs to life, ensuring each piece meets our
              standards of quality and sustainability. his love for woodworking
              shines through in every carefully crafted detail.
            </p>
          </div>
        </div>
        <Link to='/contact'>
